...
/***/ function(module, exports, __webpack_require__) {
	...
	var React, Report, child;

	__webpack_require__(1);

	React = __webpack_require__(5);

	Report = __webpack_require__(161);
	...
	React.render(React.createElement(Report, {
	  "setupComplete": false
	}), document.querySelector('#kinja_bug_reporter'));


	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/ap/code/labs/active/KinjaBugReporter/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "reporter.cjsx" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/Users/ap/code/labs/active/KinjaBugReporter/node_modules/css-loader/index.js?sourceMap!/Users/ap/code/labs/active/KinjaBugReporter/node_modules/autoprefixer-loader/index.js!/Users/ap/code/labs/active/KinjaBugReporter/node_modules/ruby-sass-loader/index.js!/Users/ap/code/labs/active/KinjaBugReporter/src/styles/report.scss", function() {
			var newContent = require("!!/Users/ap/code/labs/active/KinjaBugReporter/node_modules/css-loader/index.js?sourceMap!/Users/ap/code/labs/active/KinjaBugReporter/node_modules/autoprefixer-loader/index.js!/Users/ap/code/labs/active/KinjaBugReporter/node_modules/ruby-sass-loader/index.js!/Users/ap/code/labs/active/KinjaBugReporter/src/styles/report.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	InputGroup = __webpack_require__(166);
	...
	module.exports = React.createClass({
	  ...
	  componentDidMount: function() {
	    return chrome.runtime.onMessage.addListener((function(_this) {
	      return function(request, sender, sendResponse) {
	        _this.upload(request.image);
	        return _this.setState({
	          screenshots: [request.image].concat(slice.call(_this.state.screenshots))
	        });
	      };
	    })(this));
	  },
	    ...
	    return $.ajax({
	      ...
	      success: (function(_this) {
	        return function(response) {
	          return _this.setState({
	            urls: [response.url].concat(slice.call(_this.state.urls))
	          });
	        };
	      })(this),
	      error: function(e) {
	  ...
	  render: function() {
	    var screenshots, setup;
	    if (!this.props.setupComplete) {
	      setup = React.createElement("div", {
	        "className": "section"
	      }, React.createElement("h4", null, "Your info (you\'ll only have to enter these once)"), React.createElement("div", {
	        "className": "inputs"
	      ...
	      screenshots = this.state.screenshots.map(function(image, index) {
	    ...
	    }, screenshots)), React.createElement("div", {
	      "className": "group"
	    }, React.createElement("button", {
	      "className": "screenshot",
	      "onClick": this.screenshot
	    }, "Attach a screenshot")), React.createElement("div", {
	      "className": "group"
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/ap/code/labs/active/KinjaBugReporter/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Report.cjsx" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  handleChange: function(e) {
	    ...
	    return this.props.handleChange(obj);
	  },
	  render: function() {
	    return React.createElement("div", null, React.createElement("label", {
	      ...
	      "className": "label"
	    }, this.props.label), (this.props.type === 'text' ? React.createElement("input", {
	      "type": "text",
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/ap/code/labs/active/KinjaBugReporter/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "InputGroup.cjsx" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ghostElement, startPos, startY, started;
	...
	module.exports = {
	  startScreenshot: function() {
	    ...
	    return document.addEventListener('mouseup', this, false);
	  },
	  ...
	  sendMessage: function(msg) {
	    ...
	    return chrome.runtime.sendMessage(null, msg, null, function(response) {});
	  },
	  keyDown: function(e) {
	    var keyCode;
	    if (!started) {
	  ...
	  mouseUp: function(e) {
	    ...
	    setTimeout((function(_this) {
	      return function() {
	        ...
	        gCoords = coords;
	        e.stopPropagation();
	        return _this.endScreenshot(coords);
	      };
	    })(this), 50);
	    return false;
	  }
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/ap/code/labs/active/KinjaBugReporter/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "screenshot.coffee" + ": " + err.message); } }); } } })(); }
